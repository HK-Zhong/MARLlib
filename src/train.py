...
# marl_algo.render(
#     env, model,
#     stop={'timesteps_total': 1000000 + 9600 * 30},
#     restore_path={
#         # experiment configuration
#         'params_path': "/home/coolas-fly/MARLlib/exp_results/happo_mlp_Scenario1_0.0005_0.0007_APPEND-DATA_seed-9/HAPPO/params.json",
#         # checkpoint path
#         'model_path': "/home/coolas-fly/MARLlib/exp_results/happo_mlp_Scenario1_0.0005_0.0007_APPEND-DATA_seed-9/HAPPO/checkpoint_000105/checkpoint-105"},
#     share_policy='group',
#     checkpoint_freq=5,
#     checkpoint_at_end=True,
#     num_workers=4,
